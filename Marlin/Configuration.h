...
#define STRING_CONFIG_H_AUTHOR "(therippa)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,100,400,152.25}//147.95}  // default steps per unit for Ultimaker
